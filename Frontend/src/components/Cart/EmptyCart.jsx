  ...
  return (
    <div className="rounded-[30px] border border-slate-200 bg-white p-8 text-center shadow-[0_24px_50px_rgba(15,23,42,0.06)] sm:p-12">
      ...
      <button
        ...
        className="mt-6 inline-flex items-center justify-center rounded-full bg-emerald-600 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-emerald-600/30 transition hover:bg-emerald-500 cursor-pointer"
      >
        Continue shopping
      </button>
    </div>
